...
USER_HOME='/home/'$USER
MANDATORY_PKGS='git python3 wget vim apt-transport-https ca-certificates curl python3-pip netcat'
...
cat $CLONED_PATH/.ssh/authorized_keys | tee -a $USER_HOME/.ssh/authorized_keys >/dev/null 2>&1
